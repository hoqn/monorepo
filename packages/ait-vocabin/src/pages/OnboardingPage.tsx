...
function StepHook({ onStart }: { onStart: () => void }) {
  ...
  // phase 0: 단어 등장 → 1: 첫 줄 → 2: 둘째 줄 → 3: 버튼 등장
    ...
    <div className={styles.diagPage}>
      ...
      <div className={styles.articleButtons}>
        {['der', 'die', 'das'].map((opt) => {
          ...
          const isCorrect = opt === DIAG_WORD.answer;
          let cls = styles.articleButton;
          if (isSelected) {
            cls += ` ${isCorrect ? styles.articleCorrect : styles.articleIncorrect}`;
